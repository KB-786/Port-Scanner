...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Click += gcnew System::EventHandler(this, &TermsAndConditions::button1_Click);
			// 
			// label1
			// 
			...
			this->label1->Click += gcnew System::EventHandler(this, &TermsAndConditions::label1_Click);
			// 
			// textBox1
			// 
			...
			this->textBox1->Size = System::Drawing::Size(344, 287);
