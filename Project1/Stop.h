...
namespace Project1 {
	...
	/// Summary for Stop
	/// </summary>
	public ref class Stop : public System::Windows::Forms::Form
	{
	public:
		Stop(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Click += gcnew System::EventHandler(this, &Stop::button1_Click);
			// 
			// Stop
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(8, 16);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(60, 30);
